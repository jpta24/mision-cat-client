    ...
    <div className='col10 '>
        ...
        <div id='bautizo'>
            ...
            <div className='d-flex flex-column text-start m-5 col-8 mx-auto h5'>
                ...
                <h5>NIÑO / NIÑA</h5>
                <ul>
                    <li>Partida de nacimiento. Partida de nacimiento con fines religiosos o una copia de la misma.</li>
                </ul>
                <h5>PADRES</h5>
                <ul>
                    <li>Nombres completos de los padres, fecha de nacimiento, religión, lugar de domicilio, número de teléfono y dirección email.</li>
                    <li>Estado civil de los padres.</li>
                    <li>Si están casados por la Iglesia: fecha y lugar de la Boda.</li>
                </ul>
                <h5>PADRINOS</h5>
                <ul>
                    <li>Es necesario que sean católicos y vivan como tales.</li>
                    <li>Nombres completos, domicilio, religión.</li>
                    <li>Constancia de pertenencia a la Iglesia católica, la cual reciben en la Parroquia territorial en donde viven.</li>
                </ul>
                <h5 className='my-3'>Colocando su dirección en la siguiente página web, puede saber cuál es la parroquia territorial que le corresponde (<a href="http://www.pfarreifinder.de">www.pfarreifinder.de</a>).</h5>
                <h5 className='my-3'>Padres y padrinos tienen que asistir a la charla prebautismal de la Misión o traer constancia que asistieron a la charla prebautismal en su parroquia territorial.</h5>
            </div>
        </div>
        <hr/>
        <div id='comunion'>
        ...
        <div id='uncion'>
            ...
            <div className='d-flex flex-column text-start m-5 col-8 mx-auto h5'>
                ...
                <h5 className='my-3'>Solo se podrán hacer citas y encuentros poniéndose en contacto directo con el Presbítero.</h5>
                <ul>
